...
ifeq ($(CONFIG_NATIVE),true)
    SHARED_FLAGS += -march=alderlake -mprfchw -mno-cldemote -mavx -maes -msahf -mpclmul -mno-xop -mcrc32 -mxsaves -mno-avx512fp16 -mno-usermsr -mno-sm4 -msse4.1 -mno-avx512ifma -mxsave -mno-avx512pf -msse4.2 -mno-tsxldtrk -mno-ptwrite -mno-widekl -mno-sm3 -minvpcid -mxsavec -mno-avx10.1-512 -mno-avx512vpopcntdq -mno-avx512vp2intersect -mno-avx512cd -mmovbe -mno-avxvnniint8 -mno-avx512er -mno-amx-int8 -mno-kl -mno-avx10.1-256 -mno-sha512 -mavxvnni -mno-rtm -madx -mavx2 -mno-hreset -mmovdiri -mserialize -mvpclmulqdq -mno-avx512vl -mno-uintr -mclflushopt -mno-raoint -mno-cmpccxadd -mbmi -mno-amx-tile -msse -mgfni -mno-avxvnniint16 -mno-amx-fp16 -mxsaveopt -mrdrnd -mno-avx512f -mno-amx-bf16 -mno-avx512bf16 -mno-avx512vnni -mno-avx512bw -msse3 -mno-pku -mfsgsbase -mno-clzero -mno-mwaitx -mno-lwp -mlzcnt -msha -mmovdir64b -mno-wbnoinvd -mno-enqcmd -mno-prefetchwt1 -mno-avxneconvert -mno-tbm -mno-pconfig -mno-amx-complex -mssse3 -mcx16 -mbmi2 -mfma -mpopcnt -mno-avxifma -mf16c -mno-avx512bitalg -mno-rdpru -mclwb -mmmx -msse2 -mrdseed -mno-avx512vbmi2 -mno-prefetchi -mrdpid -mno-fma4 -mno-avx512vbmi -mshstk -mvaes -mwaitpkg -mno-sgx -mfxsr -mno-avx512dq -mno-sse4a -mtune=alderlake
endif
