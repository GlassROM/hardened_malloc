...
ifeq ($(CONFIG_NATIVE),true)
    SHARED_FLAGS += -march=alderlake -mtune=alderlake -mprfchw -mno-cldemote -mavx -maes -msahf -mpclmul -mno-xop -mcrc32 -mno-amx-fp8 -mxsaves -mno-avx512fp16 -mno-usermsr -mno-sm4 -msse4.1 -mno-avx512ifma -mxsave -msse4.2 -mno-tsxldtrk -mno-sm3 -mno-ptwrite -mno-widekl -mno-movrs -minvpcid -m64 -mxsavec -mno-avx512vpopcntdq -mno-avx512vp2intersect -mno-avx512cd -mmovbe -mno-avxvnniint8 -mno-amx-int8 -mno-kl -mno-sha512 -mavxvnni -mno-rtm -madx -mavx2 -mno-hreset -mmovdiri -mserialize -mvpclmulqdq -mno-avx512vl -mno-uintr -mclflushopt -mno-raoint -mno-cmpccxadd -mbmi -mno-amx-tile -msse -mgfni -mno-avxvnniint16 -mno-amx-fp16 -mxsaveopt -mrdrnd -mno-avx512f -mno-amx-bf16 -mno-avx512bf16 -mno-avx512vnni -mno-avx512bw -msse3 -mno-pku -mno-amx-tf32 -mno-amx-avx512 -mfsgsbase -mno-clzero -mno-mwaitx -mno-lwp -mlzcnt -msha -mmovdir64b -mno-wbnoinvd -mno-enqcmd -mno-amx-transpose -mno-avxneconvert -mno-tbm -mno-pconfig -mno-amx-complex -mssse3 -mcx16 -mbmi2 -mfma -mpopcnt -mno-avxifma -mf16c -mno-avx512bitalg -mno-rdpru -mclwb -mmmx -msse2 -mrdseed -mno-avx512vbmi2 -mno-prefetchi -mno-amx-movrs -mrdpid -mno-fma4 -mno-avx512vbmi -mshstk -mvaes -mwaitpkg -mno-sgx -mfxsr -mno-avx512dq -mno-sse4a
endif
